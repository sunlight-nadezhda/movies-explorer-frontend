      ...
      <div className="about-me__description">
        <div className="about-me__text">
          ...
          <p className="about-me__info">
            Я родилась и живу в Симферополе, закончила факультет математики и информатики ТНУ им. В.И. Вернадского. У меня есть муж и сын. Я люблю слушать музыку, а ещё увлекаюсь гимнастикой. Недавно я закончила курсы web-разработки в Яндекс.Практикуме и теперь продолжаю самостоятельно совершенствовать свои навыки.
          </p>
